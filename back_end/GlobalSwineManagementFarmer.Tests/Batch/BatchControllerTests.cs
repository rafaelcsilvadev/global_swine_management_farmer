...
public class BatchControllerTests
{
    ...
    {
        var dto = new BatchDto("BATCH001", 10, Guid.NewGuid());
    ...
    {
        var batches = new List<BatchResponse> { new BatchResponse(Guid.NewGuid(), "BATCH001", 10, Guid.NewGuid()) };
    ...
    {
        var id = Guid.NewGuid();
        var dto = new BatchDto("BATCH001-UPD", 15, Guid.NewGuid());
